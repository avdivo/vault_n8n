...
def create_or_update_secret(
    ...
    try:
        ...
        encrypted_value = crypto.encrypt_data(secret.value, settings.VAULT_N8N_ENCRYPTION_KEY)
...
def get_secrets(
    ...
    try:
        ...
        # Дешифруем значения
        decrypted_secrets = [
            models.Secret(key=k, value=crypto.decrypt_data(v, settings.VAULT_N8N_ENCRYPTION_KEY))
